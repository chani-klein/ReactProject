...
//             marginTop: '1rem'
//           }}>
//             ⚠️ לחיצה על "אני יוצא" תעביר אותך לדף הקריאות הפעילות עם ניווט
//           </div>
//         </div>
      ...
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-body">
          <div className="modal-info">
            ...
            <p><strong>🚨 דחיפות:</strong> {popupCall.urgencyLevel}</p>
            <p><strong>📍 כתובת:</strong> {address || `${popupCall.locationX}, ${popupCall.locationY}`}</p>
            <p><strong>⏰ זמן:</strong> {new Date(popupCall.date).toLocaleString('he-IL')}</p>
            {/* <p><strong>🚗 מתנדבים בדרך:</strong> {popupCall. || 0}</p> */}
          </div>
